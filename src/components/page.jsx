  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center  px-4 py-10 bg-[linear-gradient(171deg,_#180E1F_37.26%,_#4B3E56_95.51%)]">
      ...
      <div className=" md:ml-20  sm:ml-0 sm:mr-15 font-bricolage mt-20 md:text-center ">
        <b> 
            <h1 className="text-3xl sm:text-4xl md:text-5xl text-white font-medium leading-tight">Welcome to</h1>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium mt-1 bg-gradient-to-b from-[#140320] via-[#6E6476] to-white bg-clip-text text-transparent">The Indian</h2>
            <div className="text-3xl sm:text-4xl md:text-5xl text-white font-medium leading-tight">Kurash Association</div>
        </b> 
      </div>
